...
var BaseController = /** @class */ (function (_super) {
    ...
    function BaseController(entity, onlyAdmin) {
        if (onlyAdmin === void 0) { onlyAdmin = false; }
        var _this = _super.call(this) || this;
        _this._onlyAdminController = false;
        _this.errorRoot = {
            status: 401,
            errors: ['Você não está autorizado a executar essa funcionalidade!']
        };
        _this._repository = (0, typeorm_1.getRepository)(entity);
        _this._onlyAdminController = onlyAdmin;
        return _this;
    }
    BaseController.prototype.checkNoPermission = function (request) {
    ...
    BaseController.prototype.all = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (this.checkNoPermission(request))
    ...
    BaseController.prototype.one = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this._repository.findOne(uid)];
            });
        });
    };
    BaseController.prototype.save = function (model, request, isIgnore) {
        return __awaiter(this, void 0, void 0, function () {
            var uid, _modelInDB;
            return __generator(this, function (_a) {
                switch (_a.label) {
