...
var utilsHelper_1 = require("./utilsHelper");
var fs = require("fs");
...
var FileHelper = /** @class */ (function () {
    ...
    FileHelper.writePicture = function (base64Data) {
        return __awaiter(this, void 0, void 0, function () {
            var positionEndStringIdentityBase64, _base64Data, _directory, dirExists, fileName, fileNamePath, jimpResult, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        positionEndStringIdentityBase64 = (base64Data.indexOf('base64') + 7);
                        _base64Data = base64Data.substring(positionEndStringIdentityBase64);
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        fileName = utilsHelper_1.UtilsHelper.GenerateUniqueHash + ".jpg";
                        fileNamePath = _directory + "/" + fileName;
