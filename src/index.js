...
app.listen(config_1.default.port, '0.0.0.0', function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Api initialized in port " + config_1.default.port);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                error_1 = _a.sent();
                console.log('Database not conected. Error =', error_1);
                return [3 /*break*/, 4];
