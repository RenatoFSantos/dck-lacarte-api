...
var GenerateToken = /** @class */ (function () {
    function GenerateToken() {
    }
    GenerateToken.prototype.execute = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                token = {
                    ...
                    message: {
                        user: _payload,
                        token: (0, jsonwebtoken_1.sign)(__assign(__assign({}, _payload), { tm: new Date().getTime() }), config_1.default.secretKey, { expiresIn: "30s" })
                    }
                };
